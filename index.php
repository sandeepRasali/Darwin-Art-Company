...
get("/", function ($app) {
   // Whenever the server request the '/'(root) page, the following code will be executed in the callback below
...
get("/signin", function ($app) {
   ...
   // we are not using SSL in application.php so this function is not working
